...
export const fetchProducts = (): Promise<Product[]> => {
  ...
  return new Promise((resolve, reject) => {
    // añadimos un timestamp para evitar que el navegador guarde en cache una version vieja de los datos
      ...
      complete: (results) => {
        ...
        const products: Product[] = results.data
          ...
          .map((item: any, index: number) => {
            // combinamos el id de la hoja con el indice para asegurar que siempre sea unico
